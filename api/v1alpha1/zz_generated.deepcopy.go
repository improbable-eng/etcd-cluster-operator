...
func (in *BootstrapPeer) DeepCopyInto(out *BootstrapPeer) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootstrapPeer.
func (in *BootstrapPeer) DeepCopy() *BootstrapPeer {
	if in == nil {
		return nil
	}
	out := new(BootstrapPeer)
	in.DeepCopyInto(out)
	return out
}
